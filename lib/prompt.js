...
export const DEFAULT_RARITIES = [
  ...
  { name: "Uncommon", style: "green accent markings, a soft gentle sheen, slightly richer and cleaner — all held within the silhouette", edit: "keep the base pet fully intact and dominant; add only subtle GREEN accent tinting on the existing markings and a soft gentle green sheen — all held within the silhouette", color: "var(--r-uncommon)" },
  { name: "Rare", style: "blue-teal jewel-toned accent markings, crisper saturated colors, a soft cool rim-light, a few tiny sparkle glints — all held within the silhouette", edit: "keep the base pet fully intact and dominant; add a clear cool BLUE-TEAL rim-light hugging the outline and a faint blue-teal sheen on the markings; only a FEW small sparkles — all held within the silhouette", color: "var(--r-rare)" },
  { name: "Epic", style: "purple-violet energy markings, a bold dramatic palette, a glowing violet rim-light, premium 4-point sparkles — all held within the silhouette", edit: "keep the base pet fully intact and dominant; add a glowing PURPLE-VIOLET rim-light and a few premium 4-point sparkles — all held within the silhouette", color: "var(--r-epic)" },
  { name: "Legendary", style: "gold, a warm golden glow, gilded accents grown into the surface, deeper contrast, bright gold hero sparkles, majestic — all held within the silhouette", edit: "keep the base pet fully intact and dominant; add a modest warm GOLDEN rim-light and a few small gold sparkles, with light gilded tips on the crest/tail only; the pet's original fur and colors must stay clearly visible, NOT covered in gold — all held within the silhouette", color: "var(--r-legendary)" },
  { name: "Mythical", style: "crimson-ruby energy woven through the surface, a strong warm red glow, red hero sparkles, fierce and powerful — all held within the silhouette", edit: "keep the base pet fully intact and dominant; add a light RED glow around the outline and a few red sparkles, with a faint red energy tint on the existing markings only; keep most of the original fur visible, do NOT turn the pet red — all held within the silhouette", color: "var(--r-mythical)" },
  { name: "Artifact", style: "an ancient precious relic, ornate glowing engraved detail set into the surface, a turquoise-teal radiant aura, the richest sparkle set — all held within the silhouette", edit: "keep the base pet fully intact and dominant; add a restrained GOLD-AND-WHITE rim-light and a few small ornate gold sparkle accents; the base fur/colors stay clearly visible; NOTHING extends beyond the outline — strictly held within the silhouette", color: "var(--r-artifact)" },
  { name: "Heavenly", style: "divine, celestial white-gold light, a soft halo, ethereal wisps, a near-white luminous core, sacred and radiant — all held within the silhouette", edit: "keep the base pet fully intact and dominant; add a soft thin white-turquoise halo rim-light and a gentle inner light; a few small sparkles; keep the original colors clearly visible; NOTHING beyond the outline — strictly within the silhouette", color: "var(--r-heavenly)" },
  { name: "Eternal", style: "a radiant timeless eternal light infused through the surface, a layered luminous aura hugging the silhouette with slow drifting motes of light and a richer sparkle set, transcendent — one step beyond Heavenly — all held within the silhouette", edit: "keep the base pet fully intact and dominant; add a soft layered white-gold radiant rim-light and a few slow drifting light motes tight to the body; keep the base fully visible; NOTHING beyond the outline — strictly within the silhouette", color: "var(--r-eternal)" },
  { name: "Cosmic", style: "deep galaxy-nebula surface in violets, blues and magentas, swirling stardust and tiny glowing stars, the grandest awe-inspiring aura, supreme and infinite — all held within the silhouette", edit: "keep the base pet fully intact and dominant; add a subtle galaxy-nebula shimmer and tiny stars ONLY within the existing dark markings/fur, plus a soft violet rim-light and a few star sparkles; the pet's face, eyes, cream chest and shape stay clearly readable; NOTHING beyond the outline — strictly within the silhouette", color: "var(--r-cosmic)" },
];
