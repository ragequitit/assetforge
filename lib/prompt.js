...
//   edit  — what it adds when EDITING an existing base image (Rarity-tiers flow);
//           empty = "copy the base straight through" (no API call, e.g. Common)
//   color — the UI ring/swatch color
// "None" is the no-treatment tier: empty style/edit, neutral color.
export const DEFAULT_RARITIES = [
  { name: "None", style: "", edit: "", color: "var(--muted)" },
  { name: "Common", style: "muted natural honest colors, clean and simple, no glow, no sparkle, no aura — all held within the silhouette", edit: "", color: "var(--r-common)" },
  { name: "Uncommon", style: "green accent markings, a soft gentle sheen, slightly richer and cleaner — all held within the silhouette", edit: "keep the pet's identity, pose, colors and markings unchanged; add subtle GREEN accent tinting on existing markings and a soft gentle green sheen across the surface — all held within the silhouette", color: "var(--r-uncommon)" },
  { name: "Rare", style: "blue-teal jewel-toned accent markings, crisper saturated colors, a soft cool rim-light, a few tiny sparkle glints — all held within the silhouette", edit: "keep the pet's identity, pose, colors and markings unchanged; add a soft cool BLUE-TEAL rim-light hugging the silhouette, crisper saturated colors, and a few tiny sparkle glints on the body — all held within the silhouette", color: "var(--r-rare)" },
  { name: "Epic", style: "purple-violet energy markings, a bold dramatic palette, a glowing violet rim-light, premium 4-point sparkles — all held within the silhouette", edit: "keep the pet's identity, pose, colors and markings unchanged; add a glowing PURPLE-VIOLET rim-light on the silhouette, violet energy shimmer through its own surface, and a set of premium 4-point sparkles on the body — all held within the silhouette", color: "var(--r-epic)" },
  { name: "Legendary", style: "gold, a warm golden glow, gilded accents grown into the surface, deeper contrast, bright gold hero sparkles, majestic — all held within the silhouette", edit: "keep the pet's identity, pose, colors and markings unchanged; add a warm GOLDEN glow hugging the silhouette, gilded accents grown into its surface, deeper contrast, and bright gold hero sparkles on the body — all held within the silhouette", color: "var(--r-legendary)" },
  { name: "Mythical", style: "crimson-ruby energy woven through the surface, a strong warm red glow, red hero sparkles, fierce and powerful — all held within the silhouette", edit: "keep the pet's identity, pose, colors and markings unchanged; weave rich crimson-RUBY energy through its own surface, add a strong warm RED glow hugging the silhouette and red hero sparkles on the body; fierce and powerful (not prismatic) — all held within the silhouette", color: "var(--r-mythical)" },
  { name: "Artifact", style: "an ancient precious relic, ornate glowing engraved detail set into the surface, a turquoise-teal radiant aura, the richest sparkle set — all held within the silhouette", edit: "keep the pet's identity, pose, colors and markings unchanged; set ornate glowing engraved detail into its surface, add a radiant GOLD-AND-WHITE aura hugging the silhouette and the richest sparkle set on the body — all held within the silhouette", color: "var(--r-artifact)" },
  { name: "Heavenly", style: "divine, celestial white-gold light, a soft halo, ethereal wisps, a near-white luminous core, sacred and radiant — all held within the silhouette", edit: "keep the pet's identity, pose, colors and markings unchanged; add a soft halo-like divine glow hugging the silhouette, near-white luminous core highlights with icy TURQUOISE edges and holy inner light; ethereal and serene — all held within the silhouette", color: "var(--r-heavenly)" },
  { name: "Eternal", style: "a radiant timeless eternal light infused through the surface, a layered luminous aura hugging the silhouette with slow drifting motes of light and a richer sparkle set, transcendent — one step beyond Heavenly — all held within the silhouette", edit: "keep the pet's identity, pose, colors and markings unchanged; infuse a radiant timeless ETERNAL light through its surface, add a layered luminous aura hugging the silhouette with slow drifting motes of light and a richer sparkle set; transcendent, one step beyond Heavenly — all held within the silhouette", color: "var(--r-eternal)" },
  { name: "Cosmic", style: "deep galaxy-nebula surface in violets, blues and magentas, swirling stardust and tiny glowing stars, the grandest awe-inspiring aura, supreme and infinite — all held within the silhouette", edit: "keep the pet's identity, pose, colors and markings unchanged; transform its own surface into a deep GALAXY-NEBULA of cosmic violets, blues and magentas with tiny glowing stars and swirling nebula, glowing cosmic eyes, and the grandest awe-inspiring aura hugging the silhouette; go all out but stay contained within the outline", color: "var(--r-cosmic)" },
];

// Built-in edit instructions keyed by tier name, derived from DEFAULT_RARITIES.
// Used as a fallback for loadouts whose stored rarities predate the `edit` field,
// so the standard tiers keep working even before a user edits them in Settings.
